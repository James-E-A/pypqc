...
def demo_keypair():
	...
	_mceliece6960119f.lib.PQCLEAN_MCELIECE6960119F_CLEAN_crypto_kem_keypair(
	    _mceliece6960119f.ffi.from_buffer(pk),
	    _mceliece6960119f.ffi.from_buffer(sk))
...
def demo_kem_enc(pk):
	...
	_mceliece6960119f.lib.PQCLEAN_MCELIECE6960119F_CLEAN_crypto_kem_enc(
	    _mceliece6960119f.ffi.from_buffer(ciphertext),
	    _mceliece6960119f.ffi.from_buffer(shared_key),
	    pk)
...
def demo_kem_dec(sk, ciphertext):
	...
	_mceliece6960119f.lib.PQCLEAN_MCELIECE6960119F_CLEAN_crypto_kem_dec(
	    _mceliece6960119f.ffi.from_buffer(shared_key),
	    ciphertext,
	    sk)
